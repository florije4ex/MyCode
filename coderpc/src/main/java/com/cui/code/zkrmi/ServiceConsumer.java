...
public class ServiceConsumer {
    ...
    private void watchNode(final ZooKeeper zk) {
        try {
            List<String> nodeList = zk.getChildren(ConfigConstant.ZK_REGISTRY_PATH, event -> {
            ...
            for (String node : nodeList) {
                byte[] data = zk.getData(ConfigConstant.ZK_REGISTRY_PATH + "/" + node, false, null); // 获取 /registry 的子节点中的数据
